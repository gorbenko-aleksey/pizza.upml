 ...
 */
class Version20181025170529 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE document_income (id INT UNSIGNED AUTO_INCREMENT NOT NULL, creator_id INT UNSIGNED DEFAULT NULL, changer_id INT UNSIGNED DEFAULT NULL, status INT NOT NULL, description LONGTEXT DEFAULT NULL COLLATE utf8_unicode_ci, created_at DATETIME NOT NULL, changed_at DATETIME NOT NULL, INDEX IDX_81CAD3B661220EA6 (creator_id), INDEX IDX_81CAD3B6E53CD0CE (changer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE document_movement (id INT UNSIGNED AUTO_INCREMENT NOT NULL, operator_id INT UNSIGNED DEFAULT NULL, creator_id INT UNSIGNED DEFAULT NULL, type_id INT UNSIGNED DEFAULT NULL, changer_id INT UNSIGNED DEFAULT NULL, description LONGTEXT DEFAULT NULL COLLATE utf8_unicode_ci, created_at DATETIME NOT NULL, changed_at DATETIME NOT NULL, INDEX IDX_7B1C64AEC54C8C93 (type_id), INDEX IDX_7B1C64AE584598A3 (operator_id), INDEX IDX_7B1C64AE61220EA6 (creator_id), INDEX IDX_7B1C64AEE53CD0CE (changer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE document_movement_type (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE document_write_off (id INT UNSIGNED AUTO_INCREMENT NOT NULL, movement_id INT UNSIGNED DEFAULT NULL, creator_id INT UNSIGNED DEFAULT NULL, ingredient_id INT UNSIGNED DEFAULT NULL, changer_id INT UNSIGNED DEFAULT NULL, weight DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL, changed_at DATETIME NOT NULL, INDEX IDX_165A2187933FE08C (ingredient_id), INDEX IDX_165A2187229E70A7 (movement_id), INDEX IDX_165A218761220EA6 (creator_id), INDEX IDX_165A2187E53CD0CE (changer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
